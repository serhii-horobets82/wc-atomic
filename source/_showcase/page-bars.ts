...
export class PageBars extends PageAbstract {
   getMainComponent(): TemplateResult {
      return html`
         <component-flex-container containerClazz="container_50" itemFlexBasisValue="100%">
            ...
            ${this.createToolbar('secondaryColor', ToolbarAlignment.HORIZONTAL, FlexJustifyContent.SPACE_AROUND, "100px", "250px")}
   ...
   private createToolbar(primaryColor: string, toolbarAlignment: string, flexJustifyContent: string, height: string, width: string) {
      return html`
         <component-flex-container containerClazz="container_min_content ${primaryColor}" itemFlexBasisValue="100%">
            <component-toolbar height="${height}" width="${width}" .flexJustifyContent="${flexJustifyContent}" .toolbarAlignment="${toolbarAlignment}">
