...
import {Combobox, ComboboxOption} from "../../interface/atoms";

const componentCSS = require('./combobox.scss');

@customElement('component-combobox')
export class ComboboxComponent extends AbstractComponent<Combobox, KeyValueOutputData> {
